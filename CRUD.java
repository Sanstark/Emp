...
public interface CRUD {
    ...
    public int insertDataToEmployeeDB(String name, char gender, double salary, Date date, long phone, String address, String dept, int cid, String cname, String active) throws SQLException;
